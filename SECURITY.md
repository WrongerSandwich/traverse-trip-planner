...
For anything that could leak credentials, allow code execution, or otherwise cause harm to a self-hoster, please **do not file a public GitHub issue**. Instead, use [GitHub's private security advisories](https://github.com/WrongerSandwich/traverse-trip-planner/security/advisories/new) so the issue can be triaged before disclosure.
