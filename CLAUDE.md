...
- **Print / Save PDF** (itinerary tab, visible only when `itinerary.md` exists) — opens the browser print dialog. Print CSS hides all chrome so only the itinerary content renders.
